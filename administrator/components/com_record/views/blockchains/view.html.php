 ...
 * @package com_blockchain
 */
class RecordViewBlockchains extends JViewLegacy {
	...
	public function display($tpl = null) {
		...
		RecordHelper::addSubmenu('blockchains');
	...
	protected function addToolbar() {
		...
		JToolbarHelper::title('區塊鏈紀錄');
		
		if ($canDo->get('core.admin')) {
			JToolbarHelper::preferences('com_blockchain');
		}


		JHtmlSidebar::setAction('index.php?option=com_blockchain&view=items');
