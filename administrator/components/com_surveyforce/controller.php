...
class SurveyforceController extends JControllerLegacy {
	...
	public function testvote() {
		...
		$api_request_parameters = array(
			...
			'options_rows' => json_encode($options_rows),
			'sub_options_rows' => json_encode($sub_options_rows),
			'assign_summary_rows' => json_encode($assign_summary_rows),
			'cats_rows' => json_encode($cats_rows)
		);
