				...
				<div class="tab-pane" id="survey-details">
					...
					<div class="control-group form-inline">
						...
						<div class="controls">
							...
							(超連結範例：將網址用&lt;a href="<span class="url_color">連結網址</span>"&gt;<sapn class="url_color">連結名稱</sapn>&lt;/a&gt;包起來，<br>
							如需輸入兩個網址以上時，請分別用&lt;a href="<span class="url_color">連結網址</span>"&gt;<sapn class="url_color">連結名稱</sapn>&lt;/a&gt;包起來，並用<span class="url_color">&nbsp;&#59;&nbsp;</span>隔開)
							<br>(網址範例：http://XXXX 或 https://XXXX)
						</div>
					</div>
				...
				<div class="tab-pane" id="survey-settings">
					...
					<div class="control-group form-inline">
						<label id="jform_display_result-lbl" for="jform_display_result" class="control-label" aria-invalid="false">
							投票數設定</label>
						<div class="controls">                            
							<p><input type="radio" name="vote_num_type" value="0" <?php echo ($vote_num_params->vote_num_type == 0) ? "checked" : ""; ?>> 投票期間僅限一票 </p>
					...
					<div class="control-group form-inline">
						...
						<div class="controls">
							<p>
								<input type="radio" name="vote_announcement_date" value="0" <?php echo ($vote_num_params->method == 0) ? "checked" : ""; ?> /> 不公布 
							</p>
							<p class="announcement_date">
								<input type="radio" name="vote_announcement_date" value="1" <?php echo ($vote_num_params->method == 1) ? "checked" : ""; ?> /> 公布 &nbsp;&nbsp;&nbsp;&nbsp; 
							</p>
							<?php echo $this->form->getInput('announcement_date'); ?>
							<p>
								<input type="radio" name="vote_announcement_date" value="2" <?php echo ($vote_num_params->method == 2) ? "checked" : ""; ?> /> 投票結束時間                        
							</p>
						</div>
					</div>
					...
					<div class="control-group form-inline">
						<label id="jform_display_result-lbl" for="jform_display_result" class="control-label" aria-invalid="false">
							防止灌票機制</label>
						<div class="controls">
							<p><input type="radio" name="vote_num_protect" value="0" <?php echo ($vote_num_params->vote_num_protect == 0) ? "checked" : ""; ?>> 同IP 不限制 </p>
							<p><input type="radio" name="vote_num_protect" value="1" <?php echo ($vote_num_params->vote_num_protect == 1) ? "checked" : ""; ?>> 同IP 每<input type="text" id="jform_vote_num_protect_time" name="vote_num_protect_time" value="<?php echo $vote_num_params->vote_num_protect_time; ?>" size="5" class="small">秒內只能投1票</p>
									...
									foreach ($verify_mix_array as $level => $verify_array) {
										...
										foreach ($verify_array as $element => $name) {
											...
											<tr>
												...
												<?php } ?>
												<td>
													<input type="radio" id="verify_mix_<?php echo $element; ?>" class="verify_mix" name="verify_mix" value="<?php echo $element; ?>"> 
													<label for="verify_mix_<?php echo $element; ?>"><?php echo $name; ?></label>
													<a href="../filesys/images/system/VerifyExample/<?php echo $element; ?>.png" class="show_example fancybox" title="<?php echo $name; ?>">(顯示範例)</a>
												</td>
											</tr>
