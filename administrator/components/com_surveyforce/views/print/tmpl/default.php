...
<div class="survey_print">
	...
	<table border="0" class="item-list">
		...
		<tr>
			...
			<td><?php
				if ($this->survey_item->other_data) {
					$str = str_replace("filesys/ivoting/survey/pdf/" . $this->surv_id . "/", "", $this->survey_item->other_data);
					echo $str;
				}
				if ($this->survey_item->other_data2) {
					$str2 = str_replace("filesys/ivoting/survey/pdf/" . $this->surv_id . "/", "", $this->survey_item->other_data2);
					if ($this->survey_item->other_data) {
						?>，<?php
					} echo $str2;
				}
				if ($this->survey_item->other_data3) {
					$str3 = str_replace("filesys/ivoting/survey/pdf/" . $this->surv_id . "/", "", $this->survey_item->other_data3);
					if ($this->survey_item->other_data2 || $this->survey_item->other_data3) {
						?>，<?php
					} echo $str3;
				}
				if ($this->survey_item->other_data == NULL && $this->survey_item->other_data2 == NULL && $this->survey_item->other_data3 == NULL) {
					?>
					無
				<?php } ?></td>
		</tr>
		<tr>
			<th>其他參考網址</th>
			<td><?php
				if ($this->survey_item->other_url) {
					echo $this->survey_item->other_url;
				} else {
					?>無<?php } ?></td>
		</tr>
		<tr>
			<th>後續辦理情形</th>
			<td><?php
				if ($this->survey_item->followup_caption) {
					echo $this->survey_item->followup_caption;
				} else {
					?>
					無
				<?php } ?></td>
