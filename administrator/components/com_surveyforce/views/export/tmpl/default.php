...
<form action="<?php echo JRoute::_('index.php?option=com_surveyforce&view=export'); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="export-form" class="form-validate">
	...
	<div class="survey_export">
		<input type="button" id="submit_export" class="btn" value="匯出CSV檔案" onclick="check_export()" <?php if(empty($this->results)){ echo "disabled"; } ?> /><br/><br/>
								...
								<table class="table">
									...
									<tbody>
										...
										<?php
												// 顯示數目
												$num++;
//												if ($this->item->result_num_type == 1 && $result_num == $num) {
//													break;
//												}
											}
										?>
