...
var olLoaded = 0, pmStart = 10000000, pmUpper = 10001000, pmCount = pmStart + 1, pmt = '', pms = new Array(), olInfo = new Info('4.17', 1), FREPLACE = 0, FBEFORE = 1, FAFTER = 2, FALTERNATE = 3, FCHAIN = 4, olHideForm = 0, olHautoFlag = 0, olVautoFlag = 0;
...
if (typeof ol_fgcolor == 'undefined')
    var ol_fgcolor = "#CBCBCB";
if (typeof ol_bgcolor == 'undefined')
    var ol_bgcolor = "#3C79CD";
...
function createDivContainer(id, frm, zValue) {
    id = (id || 'overDiv'), frm = (frm || o3_frame), zValue = (zValue || 32000);
