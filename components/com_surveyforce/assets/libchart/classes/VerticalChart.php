                ...
                */
                ...
                function printAxis()
                {
                        ...
                        for($value = $minValue; $value <= $maxValue; $value += $stepValue)
                        {
								...
								$value = ($value + $stepValue <= $maxValue ? $value."%": $value."% "."(".$this->maxval.")");
                        ...
                        for($i = 0; $i <= $this->sampleCount; $i++)
                        {
                                ...
                                if($i < $this->sampleCount)
                                {
										...
										if (in_array($text,$this->usr_answer)) 
											$fontFileName = $this->text->fontCondensedBold;
										
                                        $this->text->printDiagonal($this->img, $x, $this->graphBRY + 10, $this->textColor, $text, $fontFileName, $columnWidth);
                ...
                */
                ...
                function printBar()
                {
                        ...
                        for($i = 0; $i < $this->sampleCount; $i++)
                        {
								...
								$fontFileName = $this->text->fontCondensed;
								if (in_array($point->getX(), $this->usr_answer)) 
									$fontFileName = $this->text->fontCondensedBold;
