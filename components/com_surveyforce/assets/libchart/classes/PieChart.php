        ...
        class PieChart extends Chart
        {
                ...
                */
                ...
                function computeLabelMargin()
                {
						...
						$this->pieLegendWidth = round($graphWidth * (1-$this->pieRatio));
                ...
                */
                ...
                function printLabel()
                {
                        ...
                        foreach($this->percent as $a)
                        {
                                ...
                                $legend = $point->getX();							
                                $legend7 = sf_SafeSplit($legend, intval($this->pieLegendWidth/7));

								list($llx, $lly, $lrx, $lry, $urx, $ury, $ulx, $uly) = @imageftbbox(8, 0, $this->text->fontCondensedBold,  $legend7, array("linespacing" => $lineSpacing));					

                                $color = $this->pieColor[$i % count($this->pieColor)];

                                $boxY1 = $this->labelTLY + $this->margin + $i * ($this->labelBoxHeight + $this->margin) + $textHeight_c;
                                ...
                                $this->text->printText($this->img, $boxX2 + $this->margin, $boxY1 + $this->labelBoxHeight / 2, $this->textColor, $legend, $this->text->fontCondensed, $this->text->VERTICAL_CENTER_ALIGN, $this->pieLegendWidth);
								
								$textHeight = $lry - $ury;		
								if (($this->labelBoxHeight + $this->margin) >= $textHeight) {
									$textHeight = 0;
								} else {
									$textHeight_c += ($textHeight-$this->labelBoxHeight/2);
								}
                                $i++;
                        }
						return ($this->labelTLY + $this->margin + $i * ($this->labelBoxHeight + $this->margin) + $textHeight_c);						
                }
