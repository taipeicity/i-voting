...
class plgSurveyImg {
	...
	public function onGetAdminOptions($_question_id) {
		...
		ob_start();
		include_once(JPATH_SITE . "/plugins/survey/img/admin/html.php");
		include_once(JPATH_SITE . "/plugins/survey/img/admin/js.php");
	...
	public function onGetOptionsHtml($_question, $_options, $_sub_options = null) {
		...
		include_once(JPATH_SITE . "/plugins/survey/img/site/js.php");
