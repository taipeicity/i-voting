...
<?php } ?>
				...
				if (stamp_num != 0) {
					for (var x = 0; x < jQuery(".option .stamp.active").length; x++) {
					    var num =  jQuery(".option .stamp.active").parent().parent().parent().children(".title")[x].innerHTML.split('.');
						if (x > 0) {
...
<?php } ?>
				...
				if (stamp_num != 0) {
					for (var x = 0; x < jQuery(".option .stamp.active").length; x++) {
					    var num = jQuery(".option .stamp.active").parent().parent().parent().children(".title")[x].innerHTML;;
						if (x > 0) {
							jQuery(".option_active")[0].innerHTML += "、" + num[0];
						} else {
							jQuery(".option_active")[0].innerHTML = num[0];
