	...
	<tbody id="table_list">
		...
		foreach ($rows as $frow) {
			...
			<tr>
				...
				<td>
					<?php if ($frow->file1) { ?>
						<a href="https://www.youtube.com/watch?v=<?php echo $frow->file1; ?>" target="_blank" title="觀看檢視">觀看檢視</a>
					<?php } ?>
					<input type="hidden" class="option_file1" name="option_file1[]" value="https://www.youtube.com/watch?v=<?php echo $frow->file1; ?>"/>
				</td>
...
<div id="new_table" style="text-align:left;  ">
	...
	<table border="1" class="edit-tbl" >
		...
		<tr>
			<td>Youtube網址*</td>
			<td>
				<input id="new_file1" style="width:300px " type="text" name="file1" value="">
