	...
	<tbody id="table_list">
		...
		foreach ($rows as $frow) {
			...
			<tr>
				...
				<td align="center">
					<?php echo $frow->ctext; ?>
					<input type="hidden" class="option_ctext" name="option_ctext[]" value="<?php echo $frow->ctext; ?>"/>
					<input type="hidden" class="option_catid" name="option_catid[]" value="<?php echo $frow->catid; ?>"/>
				</td>
	...
	<table border="1" class="edit-tbl" >
		...
		<tr>
			...
			<td>
				...
				<span id="option_cat_note">請先新增分類</span>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<br>(建議圖片原始大小為100KB 內且寬度不超過1000px )
			</td>
		</tr>
