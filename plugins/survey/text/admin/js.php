...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("#edit_btn").bind("click", function () {
            if (jQuery("#new_ftext").val() == "") {
                jQuery("#message_area").showMessage("編輯選項 - 請填寫選項名稱。");
                jQuery("#new_ftext").addClass("invalid");
                return false;
            }
        ...
        jQuery.fn.checkField = function () {
            ...
            if (parseInt(jQuery('#jform_is_multi').val()) == 1) {
                ...
                if (jQuery(".option_id").length < _min_options) {
                    jQuery("#message_area").showMessage("複選類別 - 請至少新增" + _min_options + "個選項。", jQuery("#new_ftext"));
                    return false;
                }
            } else {
                if (jQuery(".option_id").length == 0) {
                    jQuery("#message_area").showMessage("單選類別 - 請至少新增1個選項。", jQuery("#new_ftext"));
                    return false;
                }
            }
