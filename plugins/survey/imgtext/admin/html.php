		...
		foreach ($rows as $frow) {
			...
			<tr>
				...
				<td align="left">
					...
					<input type="hidden" class="option_desc" name="option_desc[]" value="<?php echo $frow->desc; ?>"/>
...
<div id="new_table" style="text-align:left;  ">
	...
	<table border="1" class="edit-tbl" >
		...
		<tr>
			<td>描述*</td>
			<td>
				<textarea name="new_desc" id="new_desc" cols="5" rows="5"></textarea>
                <p>尚餘<span id="desc_char"></span>個字元</p>
            </td>
		</tr>
